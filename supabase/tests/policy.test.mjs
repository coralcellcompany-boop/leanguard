...
import { classifySafety, fallbackReply, safetyReply, validateReply, validChange } from '../functions/_shared/coaching.ts';
import { normalizeEntitlement } from '../functions/_shared/entitlements.ts';
import { trends, hashSnapshot } from '../functions/_shared/metrics.ts';
import { isQuiet, localClock, reminderDue } from '../functions/_shared/reminders.ts';
import { generateCoachReply } from '../functions/_shared/openai.ts';
